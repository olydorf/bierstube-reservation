 ...
 */
public record ReservationRequest(int restaurant, LocalDateTime startTime, LocalDateTime endTime, int table) {
    static AtomicInteger idCounter = new AtomicInteger(0);

    public Optional<Reservation> toReservation(User user, Restaurant r) {
