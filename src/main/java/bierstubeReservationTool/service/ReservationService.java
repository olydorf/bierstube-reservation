package bierstubeReservationTool.service;
...
import bierstubeReservationTool.repository.user.ReservationRepository;
import bierstubeReservationTool.repository.user.TableRepository;
import bierstubeReservationTool.repository.user.UserRRepository;
